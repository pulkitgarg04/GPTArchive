      ...
      <div className="container px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/install" className="text-gray-600 hover:text-emerald-600 transition-colors">
                  Installation Guide
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-200 mt-12 pt-6 text-center text-gray-600 text-sm">
          <p>
            &copy; {new Date().getFullYear()} GPTArchive. All rights reserved. Made with ❤️ by {" "}
            <a
              href="https://github.com/pulkitgarg04"
              target="_blank"
