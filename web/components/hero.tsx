    ...
    <section className="py-20 md:py-28 bg-gradient-to-b from-white to-gray-50">
      <div className="container px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="inline-flex items-center px-3 py-1 rounded-full bg-gray-200 text-black text-sm font-medium mb-2 w-fit">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <Link href="/install" className="bg-emerald-600 rounded-lg text-white">
                <Button size="lg" className="group">
                  Install Extension
                  <ArrowRight className="ml-2 h-4 w-4 transition-transform group-hover:translate-x-1" />
                </Button>
              </Link>
              <Link href="#features" className="hover:bg-gray-100">
          ...
          >
            ...
            <div className="absolute -top-6 -left-6 h-24 w-24 bg-primary/10 rounded-full blur-2xl" />
          </motion.div>
        </div>
      </div>
    </section>
